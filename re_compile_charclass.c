    ...
    re__compile_charclass* char_comp, mn_uint32 tree_ref)
{
  ...
  return re__compile_charclass_tree_vec_getref(
      &char_comp->tree, (mn_size)tree_ref);
}
...
re_error re__compile_charclass_add_rune_range(
    re__compile_charclass* char_comp, mn_uint32 parent_ref,
    re__rune_range rune_range, mn_uint32 num_x_bits, mn_uint32 num_y_bits)
{
    ...
    re__compile_charclass* char_comp, mn_uint32 parent_ref)
{
  ...
  while (child_ref != RE__COMPILE_CHARCLASS_TREE_NONE) {
    ...
    }
    {
      ...
      child->aux =
          mn__murmurhash3_32(0, (const mn_uint8*)&hash_obj, sizeof(hash_obj));
    }
...
void re__compile_charclass_hash_entry_init(
    ...
    mn_uint32 root_ref, re__prog_loc prog_loc)
{
...
re__prog_loc re__compile_charclass_cache_get(
    re__compile_charclass* char_comp, mn_uint32 root_ref)
{
  ...
  if (dense_index < (mn_int32)re__compile_charclass_hash_entry_vec_size(
    ...
    re__compile_charclass* char_comp, mn_uint32 root_ref, re__prog_loc prog_loc)
{
  ...
  if (dense_index == RE__COMPILE_CHARCLASS_HASH_ENTRY_NONE) {
    ...
    mn_int32 dense_index_final =
        (mn_int32)re__compile_charclass_hash_entry_vec_size(
            &char_comp->cache_dense);
...
re_error re__compile_charclass_generate_prog(
    re__compile_charclass* char_comp, re__prog* prog, mn_uint32 node_ref,
    ...
    if (char_comp->cache_sparse == MN_NULL) {
      ...
      for (i = 0; i < RE__COMPILE_CHARCLASS_CACHE_SPARSE_SIZE; i++) {
        ...
        hash_entry = re__compile_charclass_hash_entry_vec_getref(
            &char_comp->cache_dense, (mn_size)dense_loc);
        ...
        while (hash_entry->next != RE__COMPILE_CHARCLASS_HASH_ENTRY_NONE) {
          hash_entry = re__compile_charclass_hash_entry_vec_getref(
              &char_comp->cache_dense, (mn_size)hash_entry->next);
          printf(
              "      [%i] root_ref=%04X prog_loc=%04X\n", j,
