...
MN_INTERNAL void re__compile_patches_merge(
...
MN_INTERNAL void re__compile_frame_init(
    re__compile_frame* frame, mn_int32 ast_base_ref, mn_int32 ast_child_ref,
...
MN_INTERNAL re_error re__compile_do_rune(
...
MN_INTERNAL re_error re__compile_do_str(
    re__compile* compile, re__compile_frame* frame, const re__ast* ast,
    re__prog* prog)
{
  ...
  for (i = 0; i < sz; i++) {
    if (!compile->reversed) {
      re__prog_inst_init_byte(
          &new_inst, (mn_uint8)mn__str_view_get_data(&str_view)[i]);
    } else {
      re__prog_inst_init_byte(
          &new_inst, (mn_uint8)mn__str_view_get_data(&str_view)[(sz - 1) - i]);
    }
    if (i == sz - 1) {
      /* Add an outgoing patch (1) */
      re__compile_patches_append(&frame->patches, prog, re__prog_size(prog), 0);
...
MN_INTERNAL re_error re__compile_do_charclass(
    re__compile* compile, re__compile_frame* frame, const re__ast* ast,
    re__prog* prog)
{
...
MN_INTERNAL re_error re__compile_do_concat(
    re__compile* compile, re__compile_frame* frame, const re__ast* ast,
    re__prog* prog)
{
...
MN_INTERNAL re_error re__compile_do_alt(
    re__compile* compile, re__compile_frame* frame, const re__ast* ast,
    re__prog* prog)
{
...
MN_INTERNAL re_error re__compile_do_quantifier(
    re__compile* compile, re__compile_frame* frame, const re__ast* ast,
    re__prog* prog)
{
...
MN_INTERNAL re_error re__compile_do_group(
    re__compile* compile, re__compile_frame* frame, const re__ast* ast,
    re__prog* prog)
{
  re_error err = RE_ERROR_NONE;
...
MN_INTERNAL re_error re__compile_do_assert(
    re__compile* compile, re__compile_frame* frame, const re__ast* ast,
    re__prog* prog)
{
  ...
  re__prog_inst_init_assert(
      &new_inst, (mn_uint32)assert_type); /* Creates unpatched branch (1) */
  if ((err = re__prog_add(prog, new_inst))) {
    return err;
  }
  /* Add an outgoing patch (1) */
...
MN_INTERNAL re_error re__compile_do_any_char(
    re__compile* compile, re__compile_frame* frame, const re__ast* ast,
    re__prog* prog)
{
...
MN_INTERNAL re_error re__compile_do_any_byte(
    re__compile* compile, re__compile_frame* frame, const re__ast* ast,
    re__prog* prog)
{
...
void re__compile_debug_dump(re__compile* compile)
{
  mn_int32 i;
  printf(
      "%u frames / %u frames:\n", (mn_uint32)compile->frame_ptr,
      (mn_uint32)compile->frames_size);
